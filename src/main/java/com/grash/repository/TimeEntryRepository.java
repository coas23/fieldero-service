...
public interface TimeEntryRepository extends JpaRepository<TimeEntry, Long> {
    ...
    Collection<TimeEntry> findByCompany_IdAndStartedAtBetweenAndUser_IdIn(Long companyId, Date start, Date end, Collection<Long> userIds);
    ...
    Collection<TimeEntry> findByCompany_IdAndUser_IdInAndStatus(Long companyId, Collection<Long> userIds, TimeStatus status);
}
